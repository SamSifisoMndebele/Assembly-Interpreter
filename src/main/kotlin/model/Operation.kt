...
sealed interface Operation {
    ...
    sealed interface OperationZero : Operation {
        ...
        data object EXIT : OperationZero {
            override val opcode: UByte = 0xF0u
        }
...
//        data object LEA  : OperationOne { override val opcode: UByte = 0x8Du } // Load effective address
    ...
    sealed interface OperationTwo : Operation {
        ...
        data object MOV : OperationTwo {
            override val opcode: UByte = 0x89u
        }

        data object XCHG : OperationTwo {
            override val opcode: UByte = 0x87u
        }

        data object MOVZX : OperationTwo {
            override val opcode: UByte = 0xB6u
        }

        data object MOVSX : OperationTwo {
            override val opcode: UByte = 0xBEu
        }
...
//        data object MOVSXR: OperationOne { override val opcode: UByte = 0xBFu } // Move r/m16 -> r32 with sign-extend
        ...
        data object SUB : OperationTwo {
            override val opcode: UByte = 0x29u
        }

        data object CMP : OperationTwo {
            override val opcode: UByte = 0x39u
        }
...
//        data object SBBR  : OperationTwo { override val opcode: UByte = 0x1Bu } // Subtract with borrow: r32 - r/m32 -> r32
        ...
        data object AND : OperationTwo {
            override val opcode: UByte = 0x21u
        } // r32 AND r/m32 -> r/m32

        data object OR : OperationTwo {
            override val opcode: UByte = 0x09u
        } // r32 OR r/m32 -> r/m32

        data object XOR : OperationTwo {
            override val opcode: UByte = 0x31u
        } // r32 XOR r/m32 -> r/m32
