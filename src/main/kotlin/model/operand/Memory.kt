 ...
 * @property displacement An optional displacement value used in address calculation (e.g., `[1234h]`, `[BX + 8]`).
...
data class Memory(
    ...
    val scale: UInt = 1u,
    val displacement: Long? = null
) : Operand {
    init {
        require(base != null || index != null || displacement != null) {
